...
const AGENT = {
  ...
  serviceAreas: ["Birmingham", "Bloomfield Hills", "Troy", "Royal Oak", "Berkley", "Clawson"],
  brokerageInfo: {
...
const REVIEWS = {
  ...
  totalReviewCount: 87,
  reviews: [
    { reviewerName: "Sarah M.", rating: 5, time: "2 months ago", text: "Daniel made selling our home of 20 years seamless. He priced it perfectly and we had multiple offers within a week." },
    { reviewerName: "James & Priya K.", rating: 5, time: "4 months ago", text: "As first-time buyers, we had a thousand questions. Daniel answered every one and found us a home $15K under asking." },
    { reviewerName: "Tom R.", rating: 5, time: "5 months ago", text: "Relocated from Chicago for work. Daniel knew the Birmingham and Bloomfield Hills market cold. Under contract in two weeks." },
    { reviewerName: "Linda C.", rating: 5, time: "6 months ago", text: "Professional, responsive, and honest. He told us exactly what our home was worth and sold it for full asking price." },
  ],
};
...
function ListingCard({ listing, isSold }) {
  ...
  return (
    <div
      ...
      style={{ background: "#fff", borderRadius: 2, overflow: "hidden", border: "1px solid rgba(0,0,0,0.08)", transition: "transform 0.2s, box-shadow 0.2s", transform: hovered ? "translateY(-4px)" : "none", boxShadow: hovered ? "0 12px 32px rgba(15,31,20,0.12)" : "none" }}>
...
export default function AgentPage() {
  ...
  const inputStyle = { width: "100%", ...sans, fontSize: "0.875rem", background: "rgba(245,242,237,0.06)", border: "1px solid rgba(200,169,110,0.2)", borderRadius: 2, color: C.cream, padding: "0.85rem 1rem", outline: "none" };
  ...
  return (
    <>
      ...
      {/* Navbar */}
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: "0 2rem", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between", background: scrolled ? "rgba(15,31,20,0.96)" : "transparent", backdropFilter: scrolled ? "blur(12px)" : "none", borderBottom: scrolled ? `1px solid rgba(200,169,110,0.15)` : "none", transition: "all 0.3s ease" }}>
        <span style={{ ...serif, fontSize: "1.25rem", color: C.gold, letterSpacing: "0.08em" }}>{AGENT.name}</span>
        <a href="#contact" style={{ ...sans, fontSize: "0.72rem", letterSpacing: "0.12em", textTransform: "uppercase", color: C.gold, textDecoration: "none", border: `1px solid rgba(200,169,110,0.5)`, padding: "0.5rem 1.25rem", borderRadius: 2 }}>
          Get in Touch
        </a>
      </nav>
      ...
      <section style={{ position: "relative", height: "100vh", minHeight: 600, display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(15,31,20,0.93) 0%, rgba(15,31,20,0.45) 55%, rgba(15,31,20,0.15) 100%)" }} />
        <div style={{ position: "relative", zIndex: 1, width: "100%", padding: "0 2.5rem 5rem" }}>
          <div style={{ maxWidth: 860 }}>
            <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem" }}>
              <img src={AGENT.headshotUrl} alt={AGENT.name} style={{ width: 72, height: 72, borderRadius: "50%", objectFit: "cover", border: `2px solid rgba(200,169,110,0.6)` }} />
              <div>
                <div style={{ ...sans, fontSize: "0.68rem", letterSpacing: "0.14em", textTransform: "uppercase", color: C.gold }}>{AGENT.title} · Verified Agent ✓</div>
                <div style={{ ...sans, fontSize: "0.78rem", color: "rgba(245,242,237,0.55)" }}>{AGENT.brokerage}</div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: "1rem" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>
                ...
                <span style={{ ...sans, fontSize: "0.78rem", color: "rgba(245,242,237,0.65)" }}>{REVIEWS.overallRating} · {REVIEWS.totalReviewCount} Google reviews</span>
              </div>
              <span style={{ color: "rgba(200,169,110,0.35)" }}>|</span>
              {AGENT.serviceAreas.slice(0, 4).map(a => (
                <span key={a} style={{ ...sans, fontSize: "0.68rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "rgba(245,242,237,0.55)", border: "1px solid rgba(245,242,237,0.18)", padding: "0.2rem 0.6rem", borderRadius: 2 }}>{a}</span>
              ))}
            </div>
          </div>
        </div>
        <div style={{ position: "absolute", bottom: "1.5rem", right: "2.5rem", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.4rem" }}>
          <span style={{ ...sans, fontSize: "0.62rem", letterSpacing: "0.15em", color: "rgba(200,169,110,0.55)", textTransform: "uppercase" }}>Scroll</span>
          <div style={{ width: 1, height: 40, background: "linear-gradient(to bottom, rgba(200,169,110,0.55), transparent)" }} />
        </div>
      </section>

      {/* Contact strip */}
      <div style={{ background: C.dark, padding: "1.25rem 2.5rem", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1rem", borderBottom: `1px solid rgba(200,169,110,0.12)` }}>
      ...
      <section style={{ background: C.cream, padding: "5.5rem 2rem" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "start" }}>
          <div>
            ...
            <p style={{ ...sans, fontSize: "0.875rem", lineHeight: 1.85, color: "#444", marginBottom: "2rem" }}>{AGENT.bio}</p>
            <div>
            ...
            <div style={{ marginBottom: "2.5rem" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
                {AGENT.specializations.map(s => (
                  <span key={s} style={{ ...sans, fontSize: "0.78rem", padding: "0.4rem 0.9rem", border: `1px solid rgba(42,74,53,0.3)`, borderRadius: 2, color: C.green }}>{s}</span>
                ))}
              </div>
            </div>
            <div>
      ...
      <section style={{ background: C.dark, padding: "5rem 2rem" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 1, background: "rgba(200,169,110,0.12)" }}>
            {AGENT.stats.map((s, i) => (
              <div key={i} style={{ background: C.dark, padding: "2.5rem 1.5rem", textAlign: "center" }}>
                ...
                <div style={{ ...sans, fontSize: "0.62rem", color: "rgba(245,242,237,0.3)", letterSpacing: "0.08em", textTransform: "uppercase", marginTop: "0.2rem" }}>{s.sublabel}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Sold */}
      <Section label="Track record" title="Recently Sold" bg="#fff">
        {/* TODO: replace SOLD_LISTINGS with useLiveListings("sold", agentMlsId) */}
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1.5rem" }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "3rem", flexWrap: "wrap", gap: "1rem" }}>
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ ...sans, fontSize: "0.68rem", color: "rgba(245,242,237,0.35)", marginTop: "0.25rem" }}>{REVIEWS.totalReviewCount} reviews on Google</div>
            </div>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "1.25rem" }}>
            {REVIEWS.reviews.map((r, i) => (
              <div key={i} style={{ background: "rgba(245,242,237,0.04)", border: `1px solid rgba(200,169,110,0.14)`, borderRadius: 2, padding: "1.75rem" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <span style={{ ...sans, fontSize: "0.62rem", color: "rgba(245,242,237,0.28)" }}>{r.time}</span>
                </div>
              </div>
            ))}
          </div>
          <div style={{ textAlign: "center", marginTop: "2.5rem" }}>
            <a href="#" style={{ ...sans, fontSize: "0.72rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "rgba(245,242,237,0.4)", textDecoration: "none", borderBottom: "1px solid rgba(245,242,237,0.18)", paddingBottom: 2 }}>
          ...
          {submitStatus === "success" ? (
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                <div>
                  <label style={{ ...sans, fontSize: "0.62rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(245,242,237,0.35)", display: "block", marginBottom: "0.4rem" }}>Name</label>
                  <input type="text" required placeholder="Jane Smith" value={form.name} onChange={setField("name")} style={inputStyle} />
                </div>
                <div>
                  <label style={{ ...sans, fontSize: "0.62rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(245,242,237,0.35)", display: "block", marginBottom: "0.4rem" }}>Phone</label>
                  <input type="tel" placeholder="(248) 555-0100" value={form.phone} onChange={setField("phone")} style={inputStyle} />
                </div>
              </div>
              <div>
                <label style={{ ...sans, fontSize: "0.62rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(245,242,237,0.35)", display: "block", marginBottom: "0.4rem" }}>Email</label>
                <input type="email" required placeholder="jane@email.com" value={form.email} onChange={setField("email")} style={inputStyle} />
              </div>
              <div>
                <label style={{ ...sans, fontSize: "0.62rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(245,242,237,0.35)", display: "block", marginBottom: "0.4rem" }}>Message</label>
      ...
      {/* Footer */}
      <footer style={{ background: C.darker, padding: "2.5rem", borderTop: `1px solid rgba(200,169,110,0.1)` }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "2rem", marginBottom: "2rem" }}>
            <div>
              ...
              <div style={{ ...sans, fontSize: "0.72rem", color: "rgba(245,242,237,0.35)", lineHeight: 1.8 }}>
                {AGENT.brokerageInfo.name}<br/>
                {AGENT.brokerageInfo.address}<br/>
                License #{AGENT.licenseNumber}
              </div>
            </div>
            <div style={{ ...sans, fontSize: "0.68rem", color: "rgba(245,242,237,0.22)", maxWidth: 380, lineHeight: 1.7, textAlign: "right" }}>
          ...
          <div style={{ borderTop: `1px solid rgba(200,169,110,0.1)`, paddingTop: "1.5rem", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
            <span style={{ ...sans, fontSize: "0.62rem", color: "rgba(245,242,237,0.18)" }}>© {new Date().getFullYear()} {AGENT.name} · All rights reserved</span>
            <div style={{ display: "flex", gap: "1.5rem" }}>
              {["Privacy Policy", "Terms of Use"].map(l => (
                <a key={l} href="#" style={{ ...sans, fontSize: "0.62rem", color: "rgba(245,242,237,0.28)", textDecoration: "none" }}>{l}</a>
              ))}
            </div>
          </div>
        </div>
